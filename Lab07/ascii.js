...
function setFontSize () {
    switch(document.getElementById("fontsize").value) {
        case ("Tiny") : document.getElementById("text-area").style.fontSize = "7pt"; break;
        case ("Small") : document.getElementById("text-area").style.fontSize = "10pt"; break;
        case ("Medium") : document.getElementById("text-area").style.fontSize = "12pt"; break;
        case ("Large") : document.getElementById("text-area").style.fontSize = "16pt"; break;
        case ("Extra Large") : document.getElementById("text-area").style.fontSize = "24pt"; break;
        case ("XXL") : document.getElementById("text-area").style.fontSize = "32pt"; break;
    }
}
